...
public class VendaController implements Initializable{
	...
	@FXML
	private Button btnAddCpf;

	@FXML
	private TextField txtNome;

	@FXML
	private Button btnAddNome;
	...
	@FXML
	private Label lblPreCad;

	@FXML
	private TextField txtPrecCad;

	@FXML
	private Label lblDescPor;

	@FXML
	private TextField txtDescPor;

	@FXML
	private Label lblDescDin;

	@FXML
	private TextField txtDescDin;
	...
	@FXML
	private TableColumn<?, ?> tbcPrecoUni;

	@FXML
	private TableColumn<?, ?> tbcDescPor;

	@FXML
	private TableColumn<?, ?> tbcDescDin;

	@FXML
	private TableColumn<?, ?> tbcSubTotal;

	@FXML
	private Pane pBotton;

	@FXML
	private Label lblDescontos;

	@FXML
	private Label txtDescontos;
